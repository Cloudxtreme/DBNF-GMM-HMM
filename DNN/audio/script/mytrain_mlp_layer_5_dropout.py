...
if __name__ == "__main__":
    ...
    p=L4.forward3(L3.forward3(L2.forward3(L1.forward3(x,fil0),fil1),fil2),fil3)
    p2=L4.forward2(L3.forward2(L2.forward2(L1.forward2(x))))
    ...
    trainer_diff  =theano.function(
        inputs=[x,fil0,fil1,fil2,fil3,y,lr,mm,re],outputs=cost,updates=updates_diff)
