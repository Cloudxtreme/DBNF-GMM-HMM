...
if __name__ == "__main__":
    ...
    L5=SigmoidLayer(numpy.load(mlpdirname+"/L5.W.npy"),
                    numpy.load(mlpdirname+"/L5.B.npy"))
    L6=SoftmaxLayer(numpy.load(mlpdirname+"/L6.W.npy"),
                    numpy.load(mlpdirname+"/L6.B.npy"))
    ...
    #valid_dat=numpy.fromfile("xdat/valid.xdat",dtype=">f4")
    #valid_dat=valid_dat.reshape(len(valid_dat)/L1.inum,L1.inum)
    #valid_lab=numpy.fromfile("ylab/valid.ylab",dtype=">H")
    ...
    #acc2=(1.0-tester(valid_dat,valid_lab)/float(len(valid_lab)))*100.0
    print "acc=%5.2f"%acc
    #print "acc=%5.2f"%acc2
