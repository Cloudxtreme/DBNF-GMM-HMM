...
if __name__ == "__main__":
    ...
    L1=SigmoidLayer(numpy.load(rbmdirname+"/L1.W.npy"),
                    numpy.load(rbmdirname+"/L1.B.npy"))
    L2=SigmoidLayer(numpy.load(rbmdirname+"/L2.W.npy"),
                    numpy.load(rbmdirname+"/L2.B.npy"))
    L3=SigmoidLayer(numpy.load(rbmdirname+"/L3.W.npy"),
                    numpy.load(rbmdirname+"/L3.B.npy"))
    L4=SigmoidLayer(numpy.load(rbmdirname+"/L4.W.npy"),
                    numpy.load(rbmdirname+"/L4.B.npy"))
    L5=SigmoidLayer(numpy.load(rbmdirname+"/L5.W.npy"),
                    numpy.load(rbmdirname+"/L5.B.npy"))
    L6=SoftmaxLayer(numpy.load(rbmdirname+"/L6.W.npy"),
                    numpy.load(rbmdirname+"/L6.B.npy"))
    ...
    x=T.fmatrix("x")
    p=L6.forward(L5.forward(L4.forward(L3.forward(L2.forward(L1.forward(x))))))
    ...
    numpy.save(mlpdirname+"/L5.W.npy",max_L5_W)
    numpy.save(mlpdirname+"/L5.B.npy",max_L5_B)
    numpy.save(mlpdirname+"/L6.W.npy",max_L6_W)
